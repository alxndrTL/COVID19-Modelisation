...
class Plot
{
  ...
  Plot(PApplet parent, PVector pos, String xLabel, String yLabel, int numPoints, int numGrad)
  {
    ...
    plot.getXAxis().setNTicks(numGrad); //nombre de graduations ///////////////////////////////////HERRE
    ...
    //String[] ticksLabels = {"heyy", "bonjour", "bonjour", "bonjour", "bonjour", "bonjour"}; ////////////////////////////////////////////////////////////////////////
    //plot.getXAxis().setTickLabels(ticksLabels); ////////////////////////////////////////////////////////////////////////
